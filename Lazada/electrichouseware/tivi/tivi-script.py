...
# Open URL
driver.get("https://www.lazada.vn/tv-video-am-thanh-thiet-bi-deo-cong-nghe/?spm=a2o4n.searchlistcategory.cate_3.1.21ee25bczvVg7l")
...
while True:
        ...
        try:
            ...
            df3['type'] = 'lazada'
            df3['category'] = 'electrichouseware'
            df3['subcategory'] = 'tivi'
            # ================================ GET official status
